...
//permet de modifier la variable todoshow en s    
    ...
    onUpdate=(id)=>{
        this.setState({
            ...
            (t.id===id)?<div><Update onSubmit={this.onUpdating} key={t.id} id={t.id} title={t.title} description={t.description} status={t.status} onClick={this.changePopup} /></div>:"")
    ...
    render(){
        ...
        return <div className="contain">
                ...
                {this.state.popupdate ? <div onSubmit={this.onUpdating}>{this.state.f}</div> : ""}
